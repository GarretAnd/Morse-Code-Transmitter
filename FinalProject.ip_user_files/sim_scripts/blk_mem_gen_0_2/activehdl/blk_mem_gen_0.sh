...
#
# Generated by Vivado on Mon Jun 08 15:30:57 -0500 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="O:/ENGS_31_20S/WesleyShaneGarretFinalProject_v3/FinalProject.cache/compile_simlib/activehdl"
  fi
